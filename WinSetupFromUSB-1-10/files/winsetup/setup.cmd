...
rem TOBEREPLACED string is dynamically changed by WinSetupFromUSB when prepariung source
...
REM 2000 reg.exe query "%Services%\usbehci" | findstr.exe /I "Start" && (
REM 2000 reg.exe add "%Services%\usbehci" /f /t REG_DWORD /v "Start" /d 0
REM 2000 reg.exe add "%Services%\usbehci" /f /v "Group" /d "Boot Bus Extender"
REM 2000 )
...
REM 2000 reg.exe add "%CriticalDeviceDatabase%\PCI#CC_0C0320" /f /v "ClassGUID" /d "{36FC9E60-C465-11CF-8056-444553540000}"
REM 2000 reg.exe add "%CriticalDeviceDatabase%\PCI#CC_0C0320" /f /v "Service" /d "usbehci"
...
REM 2000 reg.exe add "%Services%\usbehci" /f /v "Group" /d "Boot Bus Extender"
REM 2000 reg.exe add "%Services%\usbehci" /f /t REG_DWORD /v "Tag" /d 3
REM 2000 reg.exe add "%Services%\usbehci" /f /t REG_DWORD /v "ErrorControl" /d 1
REM 2000 reg.exe add "%Services%\usbehci" /f /t REG_DWORD /v "Start" /d 0
REM 2000 reg.exe add "%Services%\usbehci" /f /t REG_DWORD /v "Type" /d 1
